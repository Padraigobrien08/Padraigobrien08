...
I build AI systems that run in production, not just in notebooks. Right now I'm shipping LLM, RAG, and computer-vision systems at **yieldHUB**, embedded inside a commercial semiconductor analytics platform — owning them end-to-end from ambiguous requirements through to live deployment.

What I care about is the unglamorous part: **robustness, failure handling, evaluation, and human-in-the-loop design** — the things that decide whether an AI system actually holds up once real users and real data hit it.
...
<p align="center"><em>Open to AI / ML Engineer roles — London &amp; remote. Always happy to talk shop.</em></p>
